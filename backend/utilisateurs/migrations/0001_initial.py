    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMINISTRATEUR', 'Administrateur'), ('OPERATEUR', 'Opérateur'), ('OBSERVATEUR', 'Observateur')], default='OBSERVATEUR', max_length=20, verbose_name='Rôle')),
